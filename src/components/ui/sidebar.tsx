      ...
      <SidebarContext.Provider value={contextValue}>
        <TooltipProvider delayDuration={0}>
          <div
            ...
            className={cn(
              "flex min-h-svh w-full has-[[data-variant=inset]]:bg-background",
              className
            )}
            ref={ref}
            {...props}
  ...
  (
    ...
    return (
      <div
        ref={ref}
        className={cn(
          "group fixed z-40 hidden h-svh md:flex md:flex-col",
          "data-[variant=sidebar]:bg-card/70 data-[variant=sidebar]:backdrop-blur-lg",
          "data-[variant=inset]:m-2 data-[variant=inset]:h-[calc(100svh-theme(spacing.4))] data-[variant=inset]:rounded-xl data-[variant=inset]:shadow",
...
>(({ className, asChild = false, ...props }, ref) => {
  ...
  return (
    <Comp
      ...
      className={cn(
        "flex h-8 shrink-0 items-center rounded-md px-2 text-xs font-medium text-muted-foreground outline-none ring-ring transition-[margin,opacity] ease-linear focus-visible:ring-2 [&>svg]:size-4 [&>svg]:shrink-0",
        "group-data-[state=expanded]/sidebar-wrapper:ml-0 group-data-[state=expanded]/sidebar-wrapper:opacity-100",
        "group-data-[state=collapsed]/sidebar-wrapper:-ml-4 group-data-[state=collapsed]/sidebar-wrapper:opacity-0",
        className
      )}
      {...props}
    />
  ...
  return (
    <Comp
      ...
      className={cn(
        ...
        "hidden group-data-[state=expanded]/sidebar-wrapper:inline-flex",
        className
      )}
      {...props}
    />
...
const sidebarMenuButtonVariants = cva(
  "relative peer/menu-button flex items-center gap-3 overflow-hidden rounded-md p-2 text-left text-sm outline-none ring-ring transition-all hover:bg-accent hover:text-accent-foreground focus-visible:ring-2 active:bg-accent active:text-accent-foreground disabled:pointer-events-none disabled:opacity-50 group-has-[[data-sidebar=menu-action]]/menu-item:pr-8 aria-disabled:pointer-events-none aria-disabled:opacity-50 w-full justify-start",
  {
    variants: {
      ...
      isActive: {
        true: "font-semibold text-accent-foreground bg-accent",
        false: "",
      },
    },
    defaultVariants: {
    ...
    return (
      <Tooltip>
        ...
        <TooltipContent
          side="right"
          align="center"
          className="group-data-[state=expanded]/sidebar-wrapper:hidden"
          hidden={isMobile}
          {...tooltip}
        />
      </Tooltip>
...
>(({ className, asChild = false, showOnHover = false, ...props }, ref) => {
  ...
  return (
    <Comp
      ...
      className={cn(
        "absolute right-1 top-1.5 flex aspect-square w-5 items-center justify-center rounded-md p-0 text-foreground outline-none ring-ring transition-transform hover:bg-accent hover:text-accent-foreground focus-visible:ring-2 [&>svg]:size-4 [&>svg]:shrink-0",
        "after:absolute after:-inset-2 after:md:hidden",
...
>(({ className, ...props }, ref) => (
  <div
    ...
    className={cn(
      "absolute right-1 flex h-5 min-w-5 items-center justify-center rounded-md px-1 text-xs font-medium tabular-nums text-accent-foreground select-none pointer-events-none",
