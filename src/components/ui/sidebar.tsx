    ...
    return (
      <div
        ...
        className={cn(
          ...
          "data-[variant=sidebar]:bg-card data-[variant=inset]:m-2 data-[variant=inset]:h-[calc(100svh-theme(spacing.4))] data-[variant=inset]:rounded-xl data-[variant=inset]:shadow",
