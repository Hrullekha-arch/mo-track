...
export function StockLengthSticker({ stock, length, uniqueId }: StockLengthStickerProps) {
    ...
    return (
        <div 
            className="sticker-container border border-dashed border-gray-400 p-2 bg-white text-black flex flex-col justify-center items-center text-center"
