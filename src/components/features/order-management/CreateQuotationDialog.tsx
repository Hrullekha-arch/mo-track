        ...
        <div className="space-y-4">
            ...
            {fields.map((field, index) => (
                <Card key={field.id} className="p-4 flex items-end gap-4">
                    <FormField control={form.control} name={`vasDetails.${index}.vasName`} render={({ field }) => (<FormItem className="flex-grow"><FormLabel>VAS*</FormLabel><Select onValueChange={field.onChange} defaultValue={field.value}><FormControl><SelectTrigger><SelectValue placeholder="--SELECT--" /></SelectTrigger></FormControl><SelectContent><SelectItem value="vas-1">VAS 1</SelectItem></SelectContent></Select><FormMessage /></FormItem>)} />
                    ...
                    <FormField control={form.control} name={`vasDetails.${index}.room`} render={({ field }) => (<FormItem className="flex-grow"><FormLabel>Room</FormLabel><Select onValueChange={field.onChange} defaultValue={field.value}><FormControl><SelectTrigger><SelectValue placeholder="--SELECT--" /></SelectTrigger></FormControl><SelectContent><SelectItem value="living-room">Living Room</SelectItem></SelectContent></Select><FormMessage /></FormItem>)} />
