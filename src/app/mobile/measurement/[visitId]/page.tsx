...
export default function QuotationBuilderPage() {
  ...
  const generatePdfAndUpload = async () => {
    ...
    pdf.addImage(canvas.toDataURL("image/png"), "PNG", 0, 0, pageWidth, newHeight);
  
    const pdfBlob = pdf.output("blob");
    const base64Data = await blobToBase64(pdfBlob);
  
    return await uploadFileToStorageAction(`${visitId}-summary.pdf`, "application/pdf", base64Data);
  };
...
```
- src/lib/firebase-admin.ts</file>
    <content><![CDATA[
