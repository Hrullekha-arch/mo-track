...
import { SewingPin, Scissors, Package, Users, Milestone, Wind, Check, Scan, Ruler, Box, Tag, Iron, Award } from 'lucide-react';
import { cn } from '@/lib/utils';
import { Button } from '@/components/ui/button';

const PMS_PROCESS_CONFIG = [
    { id: 1, step: "Roll & Fabric Allocation", time: "15 min", icon: SewingPin },
    ...
    { id: 5, step: "Stitch panels together", time: "15 min", icon: Milestone },
    ...
    { id: 11, step: "Ironing", time: "5 min", icon: Iron },
