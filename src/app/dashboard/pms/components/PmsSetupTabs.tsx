...
type PmsSetupTabsProps = {
  vm: {
    ...
    getSkillAllowed: (machineId: string, personId: string, category: string) => boolean;
    handleAddCategory: () => void;
    handleAddDowntime: () => void;
    handleAddMachine: () => void;
    handleAddPerson: () => void;
    handleAddProduct: () => void;
    handleAddRoutingRow: () => void;
    handleQuickAddRoutingProcesses: (processes: readonly string[]) => void;
    handleSaveRouting: () => void;
    handleStartRoutingCreation: (productId: string) => void;
    handleUpdateMachine: (id: string, updates: any) => void;
    ...
    newPerson: any;
    newProduct: any;
    openImportDialog: (type: string) => void;
    people: any[];
    products: any[];
    productSearch: string;
    routing: any;
    routingNotEnteredItems: any[];
    routingRows: any[];
    savingRouting: boolean;
    selectedProductId: string;
    setDeleteDialog: (v: any) => void;
    setEditingMachine: (v: string | null) => void;
    setMachineSearch: (v: string) => void;
    setNewCategoryName: (v: string) => void;
    setNewDowntime: (fn: (prev: any) => any) => void;
    setNewMachine: (fn: (prev: any) => any) => void;
    setNewPerson: (fn: (prev: any) => any) => void;
    setNewProduct: (fn: (prev: any) => any) => void;
    setProductSearch: (v: string) => void;
    setRoutingRows: (fn: (prev: any[]) => any[]) => void;
    setSelectedProductId: (v: string) => void;
    setShowInactiveMachines: (v: boolean) => void;
    showInactiveMachines: boolean;
    skills: any[];
    updateSkill: (machineId: string, personId: string, category: string, allowed: boolean) => void;
    selectedSkillMachine: string;
    selectedSkillPerson: string;
    setSelectedSkillMachine: (v: string) => void;
    setSelectedSkillPerson: (v: string) => void;
    copyToMachine: string;
    setCopyToMachine: (v: string) => void;
    skillSearch: string;
    setSkillSearch: (v: string) => void;
    viewFilter: string;
    setViewFilter: (v: string) => void;
    getSelectedSkillCount: () => number;
    handleBulkUpdateCurrentSelection: (allowed: boolean) => void;
    handleCopySkills: () => void;
    handleDeleteAllSkills: (machineId: string, personId: string) => void;
    getUniqueAssignments: () => number;
    getGroupedSkills: () => Array<{ header?: string; items: any[] }>;
  };
};
