...
export function OverviewTab({
  ...
  const employeesMissingOnboarding = activeEmployees.filter(
    (entry) => !entry.joiningDate || !entry.department || !entry.reportingManager
  );
  ...
  const moduleCards = [
    ...
    {
      label: "Attendance",
      description: "Biometric attendance import, daily summary, and holiday calendar.",
    ...
    {
      label: "Onboarding",
      description: "7-point checklist, profile completion, and joining readiness.",
