      ...
      <Card className="border-slate-200">
        <CardHeader className="gap-4 md:flex-row md:items-end md:justify-between">
          <div>
            ...
            <CardDescription>
              Per-employee monthly attendance breakdown. Sync from biometric API or add manually.
            </CardDescription>
          </div>
        ...
        <Card className="border-slate-200">
          <CardHeader>
            ...
            <CardDescription>
              ...
              &nbsp;14-min grace applied on sync (arrivals up to 10:{String(ATTENDANCE_GRACE_MINUTES).padStart(2, "0")} treated as Present).
            </CardDescription>
          </CardHeader>
