        ...
        <style>
          ...
          * { box-sizing: border-box; }
          ...
          @media print {
            ...
            .brand-mark { width: 124px; height: 64px;}
            ...
            .metric-grid, .section-grid { gap: 8px; }
            .metric-card { padding: 10px 10px; min-height: 0; }
            ...
            .table-card, .summary-card, .bank-details-card, .note-card { border-radius: 12px; }
            .table-card h3, .summary-card h3, .bank-details-card h3 { padding: 10px 10px 8px; font-size: 13px; }
            ...
            .bank-section { margin-top: 10px; padding-top: 12px; }
            .bank-details-body { padding: 6px 10px; }
            .bank-row { gap: 10px; padding: 6px 0; }
            .bank-row .label { font-size: 9px; }
            .bank-row .value { font-size: 10px; max-width: 60%; }
            ...
            <div class="hero">
              <div class="header">
                ...
                <div class="company">
                  ...
                  <p>B-50, Golf Course Road, Sushant Lok- 2, Sector 56, Gurugram, Haryana - 122011</p>
