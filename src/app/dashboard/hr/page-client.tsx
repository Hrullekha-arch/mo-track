...
const EmployeeDetailsDialog = dynamic(() => import("./dialogs").then((mod) => mod.EmployeeDetailsDialog), { ssr: false });
const PayrollSetupDialog = dynamic(() => import("./dialogs").then((mod) => mod.PayrollSetupDialog), { ssr: false });
const SalarySlipDialog = dynamic(() => import("./dialogs").then((mod) => mod.SalarySlipDialog), { ssr: false });
const AttendanceUploadDialog = dynamic(() => import("./dialogs").then((mod) => mod.AttendanceUploadDialog), { ssr: false });
const HolidayDialog = dynamic(() => import("./dialogs").then((mod) => mod.HolidayDialog), { ssr: false });
const ManageAttendanceDialog = dynamic(() => import("./dialogs").then((mod) => mod.ManageAttendanceDialog), { ssr: false });
const LetterDialog = dynamic(() => import("./dialogs").then((mod) => mod.LetterDialog), { ssr: false });
const LoanDialog = dynamic(() => import("./dialogs").then((mod) => mod.LoanDialog), { ssr: false });
const WarningDialog = dynamic(() => import("./dialogs").then((mod) => mod.WarningDialog), { ssr: false });
const ExpenseClaimDialog = dynamic(() => import("./dialogs").then((mod) => mod.ExpenseClaimDialog), { ssr: false });
const RosterEntryDialog = dynamic(() => import("./dialogs").then((mod) => mod.RosterEntryDialog), { ssr: false });
const AppraisalDialog = dynamic(() => import("./dialogs").then((mod) => mod.AppraisalDialog), { ssr: false });
const IncrementDialog = dynamic(() => import("./dialogs").then((mod) => mod.IncrementDialog), { ssr: false });
const JobDialog = dynamic(() => import("./dialogs").then((mod) => mod.JobDialog), { ssr: false });
const ApplicantDialog = dynamic(() => import("./dialogs").then((mod) => mod.ApplicantDialog), { ssr: false });
const SelfServiceRequestDialog = dynamic(() => import("./dialogs").then((mod) => mod.SelfServiceRequestDialog), { ssr: false });
const DepartmentDialog = dynamic(() => import("./dialogs").then((mod) => mod.DepartmentDialog), { ssr: false });
const DesignationDialog = dynamic(() => import("./dialogs").then((mod) => mod.DesignationDialog), { ssr: false });
const BranchDialog = dynamic(() => import("./dialogs").then((mod) => mod.BranchDialog), { ssr: false });
  ...
  return (
    <div className="container mx-auto space-y-4 p-3 md:p-4 lg:p-5">
      ...
      {attendance.showAttendanceUpload ? (
        <AttendanceUploadDialog employees={activeEmployees} month={selectedMonth} saving={attendance.savingAttendance} onClose={() => attendance.setShowAttendanceUpload(false)} onUpload={attendance.uploadAttendanceRecords} />
      ) : null}
