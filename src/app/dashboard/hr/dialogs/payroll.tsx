        ...
        <div className="max-h-[calc(96vh-76px)] overflow-y-auto bg-slate-50/80 px-4 py-4 sm:px-6">
          <div className="mx-auto w-full overflow-hidden rounded-[28px] border border-slate-200 bg-white shadow-[0_18px_48px_rgba(15,23,42,0.06)]">
            ...
            <div className="border-t border-slate-100 px-5 py-5 sm:px-6">
              <Card className="rounded-[24px] border-slate-200 shadow-none">
                <CardHeader className="border-b border-slate-100 pb-3.5 pt-4.5">
                  <CardTitle className="text-sm font-semibold uppercase tracking-[0.14em] text-slate-500">Bank & Compliance Details</CardTitle>
                </CardHeader>
                <CardContent className="space-y-2 p-5">
                  {bankDetailsRows.map((row) => (
                    <div
                      key={row.label}
                      className="flex flex-col gap-1 border-b border-slate-100 pb-2.5 last:border-b-0 last:pb-0 sm:flex-row sm:items-start sm:justify-between sm:gap-4"
                    >
                      <span className="text-[11px] font-semibold uppercase tracking-[0.12em] text-slate-500">{row.label}</span>
                      <span className="text-sm font-semibold text-slate-950 sm:max-w-[60%] sm:text-right [overflow-wrap:anywhere] break-words">
                        {row.value}
                      </span>
                    </div>
                  ))}
